...
var scrollToElement = function(el) {
	var topoffset = document.getElementsByClassName('navbar')[0].offsetHeight + 10; // variable for menu height	
  $("html,body").animate({scrollTop: $(el).offset().top - topoffset},500);
};
